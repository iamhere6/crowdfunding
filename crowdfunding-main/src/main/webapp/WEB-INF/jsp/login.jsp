...
<div class="container">
    ...
    <form id="loginForm" class="form-signin" role="form" action="doLogin">
        ...
        <div class="form-group has-success has-feedback">
            <input type="password" class="form-control" id="loginpswd" name="loginpswd" value="123456" placeholder="请输入登录密码" style="margin-top:10px;">
            <span class="glyphicon glyphicon-lock form-control-feedback"></span>
        </div>
        <!-- 后台登录和前台登录是分开做的，这里注释掉 -->
        <%--<div class="form-group has-success has-feedback">
...
<script>
    ...
    function doLogin() {
        ...
        $("#loginForm").submit(); // 提交之后，找doLogin映射（存在于DispatcherController类）
    }
</script>
</body>
</html>
